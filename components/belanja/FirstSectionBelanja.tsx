...
export default function FirstSectionBelanja() {
    return (
        <section className="w-full bg-[#1172BA] flex flex-col justify-center items-center text-center px-4 py-10 mb-[0%] md:py-5 md:mb-[0%] min-h-[5vh] md:min-h-[35vh] relative overflow-hidden">
            {/* Catatan Posisi: 
      ...
      */}
            ...
            <div className="max-w-5xl mx-auto flex flex-col items-center justify-center">
                ...
                <motion.h1
                    ...
                    className="font-['Nohemi'] text-[36px] sm:text-[48px] md:text-[72px] font-semibold leading-tight mb-4 md:mb-6 tracking-tight"
                >
                ...
                <motion.p
                    ...
                    className="font-['Nohemi'] text-[16px] sm:text-[20px] md:text-[24px] font-normal text-white max-w-3xl opacity-95 leading-relaxed"
                >
