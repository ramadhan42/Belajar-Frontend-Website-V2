...
const products = [
    ...
    { id: 3, name: "Evomi Aroma 3", price: "Rp 150.000", desc: "Scent of energy" },
        ...
        <section className="w-full px-5 md:px-12 lg:px-24 py-16 bg-[#1172BA]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 max-w-7xl mx-auto">
                {products.map((product, index) => {
                    ...
                    const rotationClass = index % 2 === 0 ? "hover:rotate-[5deg]" : "hover:-rotate-[5deg]";
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="w-full aspect-square bg-gray-100 rounded-2xl mb-5 flex items-center justify-center">
                                <span className="text-gray-400 text-sm">Gambar {product.id}</span>
