...
export default function SeventhSection() {
  return (
    <section
      className="relative w-full min-h-screen bg-white flex flex-col md:flex-row items-center justify-between px-6 sm:px-12 md:pl-24 md:pr-0 py-16 md:py-24 overflow-hidden select-none"
      style={{ fontFamily: "'Nohemi', sans-serif" }}
    >

      {/* ================= SISI KIRI: KONTEN TEKS & TOMBOL ================= */}
      <div className="relative z-10 flex flex-col justify-between items-start h-full max-w-xl gap-12 md:gap-24 mb-20 md:mb-0 md:left-15">

        {/* Disisi Kiri Atas: Judul Utama */}
        <h2
          className="font-['Nohemi'] md:text-[67px] font-semibold leading-[1.1] tracking-tighter whitespace-pre-line text-left transition-all duration-300 ease-out hover:rotate-[3deg] cursor-pointer origin-left"
        >
