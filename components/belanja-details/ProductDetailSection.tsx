...
const productsData: Record<string, {
    ...
    middleNote: string;
    baseNote: string;
    images: string[]; characterPath: string; // Tambahkan ini
}> = {
    "1": {
...
export default function ProductDetailSection() {
    ...
    const currentImages = product.images.length > 0 ? product.images : ["/src/images/belanja/detail/purpose/gambar-card-utama.png"];
        ...
        <section className="bg-[#F6F6F6] w-full pt-12 pb-24 px-4 md:px-8 relative overflow-hidden flex flex-col items-center">
            ...
            <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mt-6 mb-16 z-10">
                ...
                <div className="lg:col-span-5 flex flex-col items-center lg:items-end w-full select-none">
                    ...
                    <div className="w-full max-w-[482px] aspect-square rounded-[24px] overflow-hidden flex justify-center items-center relative shadow-sm" style={{ backgroundColor: product.navbarColor }}>
                        <Image
                            src={currentImages[currentIndex] || currentImages[0]}
                    ...
                    <div className="flex gap-2.5 my-5 justify-center w-full max-w-[482px]">
                        {currentImages.map((_, index) => (
                            <button
                                ...
                                style={{ backgroundColor: currentIndex === index ? product.navbarColor : undefined }}
                ...
                <div className="lg:col-span-7 flex flex-col text-left w-full lg:pl-4 relative">
                    ...
                    <h1 className="font-['Nohemi'] text-[40px] md:text-[56px] font-semibold leading-tight mb-2" style={{ color: product.navbarColor }}>
                        {product.title}
                    </h1>
                    ...
                    <div className="bg-white border border-gray-100 rounded-[20px] p-6 shadow-sm max-w-2xl mb-8 flex flex-col gap-5">
                        <h4 className="font-['Nohemi'] text-[18px] md:text-[20px] font-bold" style={{ color: product.navbarColor }}>
                            Notes {product.title}
                        </h4>

                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                            <span className="text-white text-[14px] font-medium px-4 py-1.5 rounded-full min-w-[110px] text-center" style={{ backgroundColor: product.navbarColor }}>
                                Top Note
                            </span>
                            <span className="text-[14px] font-medium" style={{ color: `${product.navbarColor}CC` }}>
                                {product.topNote}
                            </span>
                        </div>
                    ...
                    <div className="font-['Nohemi'] flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-6 md:gap-8 mb-8 md:mb-12 md:mt-5">
                        <span className="text-[22px] md:text-[24px] font-medium" style={{ color: product.navbarColor }}>
                            Harga
                        </span>
                    ...
                    <div className="flex flex-wrap items-center gap-4 max-w-2xl">
                        <button
                            ...
                            style={{ color: product.navbarColor, borderColor: `${product.navbarColor}33` }}
                        >
                        ...
                        <button className="font-['Nohemi'] flex items-center justify-center gap-2 text-white text-[16px] font-medium px-8 py-4 rounded-full shadow-md active:scale-95 transition-all duration-200" style={{ backgroundColor: product.navbarColor }}>
                            Beli langsung
                            <Image
