...
export default function Footer() {
    return (
        <footer className="w-full bg-[#1172BA] py-12 md:py-16 px-6 md:px-24" style={{ fontFamily: "'Nohemi', sans-serif" }}>
            ...
            <div className="flex flex-col lg:flex-row justify-between gap-y-12 lg:gap-y-0 mb-12 md:mb-16 px-0 md:px-4">
                ...
                {/* Bagian Kiri (Atas di Mobile): Buletin */}
                <div className="flex flex-col gap-3 md:gap-4 w-full lg:w-[40%] max-w-[380px] mx-auto lg:mx-0 text-center lg:text-left items-center lg:items-start">
                    ...
                    <div className="flex items-center bg-white rounded-full p-1 w-full h-[44px] md:h-[48px] mt-2">
                        <input
                            ...
                            className="flex-grow bg-transparent outline-none px-4 text-[12px] md:text-[14px] text-gray-500 placeholder-gray-300"
                        />
                        <button className="bg-[#1172BA] text-white w-[85px] md:w-[97px] h-[36px] md:h-[40px] rounded-full text-[12px] md:text-[14px] font-bold hover:bg-[#0e5d99] transition-colors">
                            Daftar
                        </button>
                    </div>
                </div>

                {/* Bagian Kanan (Bawah di Mobile): Menu, Bantuan, Social - Sejajar Horizontal */}
                <div className="flex flex-row justify-between items-start w-full lg:w-[50%] gap-2 sm:gap-8 mt-4 lg:mt-0">
                    
                    {/* Kolom 2: Menu */}
                    <div className="flex flex-col gap-2 md:gap-4 w-1/3">
