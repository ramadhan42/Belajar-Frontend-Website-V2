  ...
  return (
    <section className="relative bg-white w-full min-h-[350px] sm:min-h-[500px] md:min-h-[800px] flex justify-center items-center pt-10 sm:pt-16 md:pt-20 pb-20 sm:pb-28 md:pb-40 overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col items-center z-10">
            <div className="relative w-[32px] h-[32px] sm:w-[40px] sm:h-[40px] md:w-[64px] md:h-[64px] cursor-pointer transition-transform duration-1500 ease-in-out hover:rotate-[180deg]">
              <Image src="/src/images/section 4/recycle.png" alt="Recycle Icon" fill className="object-contain" />
            </div>
      ...
      <div className="absolute bottom-0 left-0 w-full leading-[0] overflow-hidden z-20">
        ...
        <svg className="animate-wave-div-slow absolute bottom-0 block w-[200%] h-[30px] sm:h-[50px] md:h-[80px] opacity-50" viewBox="0 0 2000 100" preserveAspectRatio="none">
          <path d="M0 50 Q 250 0 500 50 T 1000 50 T 1500 50 T 2000 50 V 100 H 0 Z" fill="#60BBFF" />
        </svg>

        <svg className="animate-wave-div-fast relative block w-[200%] h-[20px] sm:h-[40px] md:h-[65px]" viewBox="0 0 2000 100" preserveAspectRatio="none">
          <path d="M0 50 Q 250 100 500 50 T 1000 50 T 1500 50 T 2000 50 V 100 H 0 Z" fill="#60BBFF" />
        </svg>
      </div>
    </section>
  );
